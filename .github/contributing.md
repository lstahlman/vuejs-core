...
> **Agent-driven contributions:** If you are an AI coding agent (or reviewing one), also follow [`AGENTS.md`](../AGENTS.md), which codifies the same conventions for automated workflows.
